    ...
    i.addEventListener('click',()=>{
        ...
        if (a===0) 
        {
          ...
          audience_btn.style.color = "#1ca1f1";
            ...
            audience_btn.innerHTML = `Social Circle <i class="fas fa-angle-down">`; 
...
Array.from(document.getElementsByClassName('who_can_reply')).forEach((i,a) => {
    i.addEventListener('click',()=>{
        ...
        if (a===0) 
        {
            select_reply_btn.innerHTML = `Everyone can reply  <i class="fas fa-globe-asia">`; 
            select_reply_btn.style.color = "#1ca1f1";
            select_reply_btn.style.borderColor = "#1ca1f1";
        }
        
        else if(a===1) {
            select_reply_btn.innerHTML = `People you know  <i class="fas fa-user-check">`; 
            select_reply_btn.style.color = "green";
            select_reply_btn.style.borderColor = "green";
        }
        else{
            select_reply_btn.innerHTML = `People you mention  <i style="font-style:normal"  > @`;
            select_reply_btn.style.color = "green";
            select_reply_btn.style.borderColor = "green";
        }
        who_can_reply_bx.classList.toggle('show_bx_active');
